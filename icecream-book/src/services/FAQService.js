...
const BASE_URL = 'http://localhost:8080/api/task/faq/';
...
const findByQuestion = question => {
  return axios.get(BASE_URL + `question=${question}`);
}
export default { getAll, getById, create, update, remove, findByQuestion};